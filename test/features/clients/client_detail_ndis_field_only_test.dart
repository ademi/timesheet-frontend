...
void main() {
  ...
  test(
    'loadTypeTabForSelected excludes Overview-owned ndis/dob requirements',
    () async {
      ...
      expect(controller.requirementDrafts, hasLength(1));
      expect(
        controller.requirementDrafts.single.requirement.requirementKey,
        'identity_100_point',
      );
    },
  );
