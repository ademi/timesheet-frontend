            ...
            child: Column(
              ...
              children: [
                DropdownButtonFormField<String>(
                  value:
                      controller.batchStatusFilter.value.isEmpty
                          ? null
          ...
          PageContent(
            child: Column(
              ...
              children: [
                ...
                if (controller.contractorCandidates.isNotEmpty)
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon:
                          controller.contractorFilter.value.isEmpty
                              ? null
                              : IconButton(
                                tooltip: 'Clear filter',
                                onPressed:
                                    controller.contractorFilterCtrl.clear,
                ...
                for (final contractor
                    in controller.filteredContractorCandidates)
                  Card(
                    ...
                    child: ExpansionTile(
                      ...
                      leading: Checkbox(
                        value: controller.selectedContractorIds.contains(
                          contractor.contractorId,
                        ),
                        onChanged:
                            controller.canManage
                                ? (_) => controller.toggleContractor(
                                  contractor.contractorId,
                                )
                                : null,
                      ),
                      ...
                      children: [
                        ...
                        for (final visit in contractor.visits)
                          ListTile(
                            ...
                            dense: true,
                            title: Text(
                              visit.jobTitle ?? visit.tenantName ?? visit.id,
                            ),
                            subtitle: Text(
                ...
                if (controller.canManage) const SizedBox(height: 8),
